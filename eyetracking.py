            ...
            if eari<EYE_AR_THRESH:  
                ...
                if (y3>1 and x3>1):
                    ...
                    if(mov_y>0 and mov_x>0):
                        if((y32-2<=y3<y32+1) and (x32-2<=x3<x32+1)):
                    ...
                    if(mov_y<pyautogui.size()[1] and mov_x<pyautogui.size()[0]):
                        if((y32-2<=y3<y32+1) and (x32-2<=x3<x32+1)):
                            ...
                            mov_x=pyautogui.size()[0]-60
                            mouse.move(mov_x,mov_y)
                elif (-1<y3<1 and x3<-1) :
                    cv.putText(frame,"CENTRO y derecha",(50,200),font,2,(0,0,255),3)
                    if((y32-2<=y3<y32+1) and (x32-2<=x3<x32+1)):
                        mov_x,mov_y=mouse.get_position()
                        mouse.move( mov_x,mov_y)
                    else:
                        ...
                        mov_x=pyautogui.size()[0]-60
                        mouse.move(mov_x,mov_y)
                elif (-1<x3<1 and y3>1) :
                    cv.putText(frame,"CENTRO y arriba",(50,200),font,2,(0,0,255),3)
                    if((y32-2<=y3<y32+1) and (x32-2<=x3<x32+1)):
                        mov_x,mov_y=mouse.get_position()
                        mouse.move( mov_x,mov_y)
                    else:
