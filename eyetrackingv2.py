        ...
        if results.multi_face_landmarks:
            ...
            if eari<EYE_AR_THRESH:  
                ...
                if y3>1:
                    ...
                    if(mov_y>0):
                        if(0.5*y32<y3<y32):
                            mouse.move(mov_x,mov_y,duration=0.25)
                        else:
                            mov_y=centroy-y3*Gyar
            ...
            if eard<EYE_AR_THRESH:
                ...
                if (COUNTERD >= EYE_AR_CONSEC_FRAMES):
                    ...
                    mouse.move(mov_x,mov_y,duration=1)
                    COUNTERD = 0                 
        
            cv.putText(frame,str(x32),(100,100),font,2,(0,0,255),3)
            cv.putText(frame,str(y3),(100,150),font,2,(0,0,255),3)
            cv.putText(frame,str(y32),(150,250),font,2,(0,0,255),3)
            cv.putText(frame,str(x3),(50,250),font,2,(0,0,255),3)
